...
export const metadata = {
  ...
  alternates: { 
    canonical: "/pdftojpg" // relative, resolves with metadataBase
  },
  openGraph: {
    title: "PDF to JPG Converter - Convert Your PDF to Image Online",
    description:
    ...
    <main className="max-w-3xl mx-auto p-8">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://www.jpgstopdf.com/pdftojpg", // absolute, no trailing slash
            description:
      ...
      <section className="max-w-4xl mx-auto mb-16">
        <h2 className="text-2xl font-bold mb-4">
          Best Practices for Converting PDF to JPG
        </h2>
